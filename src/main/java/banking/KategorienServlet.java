...
/**
 * Servlet implementation class KategorienServlet
 */


// Dieses Servlet dient zu verwaltung und annahme von POST-requests f�r das Erstellen von Kategorien 
...
public class KategorienServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// leitet auf die konto.jsp weiter um anschlie�end wieder da zu sein, wo das form gesendet wurde. 
		
		
	
	}

	// hier wird nur das Form f�r die Kategorien in der konto.jsp verarbeitet. 
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (kategorie != null) {
			...
			System.out.println("KategorienServlet: Kategorie "+ kategorie + "Schlagw�rter " + schlagwoerter_feld); 
				...
				// vernwandeln der mit komma-getrennten schlagw�rter im form in ein arraylist. 
